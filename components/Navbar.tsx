...
const Navbar: React.FC = () => {
    ...
    const [providers, setProviders] = useState<{   [s: string]: {     id: string;   }; } | ArrayLike<{   id: string; }> | null>(null);
          ...
          <div className='relative flex h-20 items-center justify-between'>
            <div className='absolute inset-y-0 left-0 flex items-center md:hidden'>
              ...
              <button
                ...
                className='relative inline-flex cursor-pointer items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:ring-2 focus:ring-white focus:outline-none focus:ring-inset'
            ...
            <div className='flex flex-1 items-center justify-center md:items-stretch md:justify-start'>
              ...
              <Link className='flex flex-shrink-0 items-center' href='/'>
                <NextImage className='h-10 w-auto' src={logo} alt='PropertyPulse' />
            ...
            {!session && (
              <div className='hidden md:ml-6 md:block'>
                <div className='flex items-center'>
                  {providers &&
                    Object.values(providers).map((provider: {id: string}, index: number) => (
                      <button
                        key={index}
                ...
                <div className='relative ml-3'>
                  <div>
                    ...
                    >
                      ...
                      <NextImage className='h-8 w-8 rounded-full' src={profileImage || defaultProfile} width={40} height={40} alt='' />
                    </button>
                  </div>
